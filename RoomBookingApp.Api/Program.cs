...
{
    var builderObj = new DbContextOptionsBuilder<RoomBookingAppDbContext>();
    builderObj.UseSqlite(sqliteConnection);

    using var context = new RoomBookingAppDbContext(builderObj.Options);
